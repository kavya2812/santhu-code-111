...
# 2 pass the number of data points you want  as counter
def random_set_of_mean(counter):
    ...
    # 1 Pass the number of time you want the mean of the data points as a parameter in range function in for loop
mean_list = []
